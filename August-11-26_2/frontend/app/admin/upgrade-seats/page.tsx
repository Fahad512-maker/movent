...
function UpgradeSeatsContent() {
  ...
  // Client Portal Seats purchase is hidden — this page only ever offers
  // Company Slots now, regardless of ?type= in the URL.
  const [type, setType] = useState<PurchaseType>('companies');
    ...
    <DashboardLayout title="Upgrade">
      <div style={{ maxWidth: 780 }}>
        <div style={{ marginBottom: 20 }}>
          <h1 style={{ fontSize: 22, fontWeight: 800, color: '#0f172a', margin: 0 }}>Upgrade Company Slots</h1>
          <p style={{ margin: '4px 0 0', fontSize: 13, color: '#94a3b8' }}>Raise your account's company limit</p>
        </div>
